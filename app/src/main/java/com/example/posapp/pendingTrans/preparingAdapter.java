...
public class preparingAdapter extends RecyclerView.Adapter<servingViewholder>{
    Context context;
    List<preparingItems> items;

    public preparingAdapter(Context context, List<preparingItems> items) {
